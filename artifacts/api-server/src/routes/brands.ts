  ...
  try {
    const brands = await db
      .select({
        ...
        whatsapp: brandsTable.whatsapp,
        telegram: brandsTable.telegram,
        facebook: brandsTable.facebook,
        instagram: brandsTable.instagram,
        email: brandsTable.email,
        phone: brandsTable.phone,
    ...
    // keep UI alive on prod DB dialect/schema mismatches
    res.json([]);
  }
});
