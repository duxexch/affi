  ...
  try {
    const cats = await db
      .select({
        ...
        whatsapp: categoriesTable.whatsapp,
        telegram: categoriesTable.telegram,
        facebook: categoriesTable.facebook,
        instagram: categoriesTable.instagram,
        email: categoriesTable.email,
        phone: categoriesTable.phone,
        website: categoriesTable.website,
