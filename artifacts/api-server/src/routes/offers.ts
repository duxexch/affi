...
function buildOfferSelect() {
  return db
    .select({
      ...
      whatsapp: offersTable.whatsapp,
      telegram: offersTable.telegram,
      facebook: offersTable.facebook,
      instagram: offersTable.instagram,
      email: offersTable.email,
      phone: offersTable.phone,
      website: offersTable.website,
