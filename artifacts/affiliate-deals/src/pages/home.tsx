...
import { OfferGridSkeleton, CategoryCardSkeleton, BrandCardSkeleton } from "@/components/skeletons";
  ...
  return (
    <Layout>
      <Seo
        ...
        description="Discover the sharpest discounts across top brands and categories. Curated daily, updated hourly."
        url="/"
      ...
      <section className="py-12 md:py-20 text-center">
        ...
        <div className="flex flex-col sm:flex-row justify-center gap-4">
          ...
          <Button asChild variant="outline" size="lg" className="font-bold text-lg rounded-full px-8">
      ...
      <section className="mb-16">
        <div className="flex items-center justify-between mb-8">
          <h2 className="text-2xl font-bold flex items-center gap-2">
            <Zap className="h-6 w-6 text-primary" /> Trending Offers
          </h2>
        ...
        {isLoadingOffers ? (
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-6">
            {offersData.items.map(offer => <OfferCard key={offer.id} offer={offer} />)}
          </div>
        ) : (
          <div className="text-center py-12 text-muted-foreground bg-muted/30 rounded-lg">No trending offers found.</div>
        )}
      </section>
      ...
      <section className="mb-16">
        <div className="flex items-center justify-between mb-8">
          <h2 className="text-2xl font-bold flex items-center gap-2">
            <Hexagon className="h-6 w-6 text-primary" /> Top Categories
          </h2>
        ...
        {isLoadingCategories ? (
          ...
          <div className="text-center py-12 text-muted-foreground bg-muted/30 rounded-lg">No categories found.</div>
        )}
      </section>
      ...
      <section className="mb-16">
        <div className="flex items-center justify-between mb-8">
          <h2 className="text-2xl font-bold flex items-center gap-2">
            <Tag className="h-6 w-6 text-primary" /> Popular Brands
          </h2>
        ...
        {isLoadingBrands ? (
          ...
          <div className="text-center py-12 text-muted-foreground bg-muted/30 rounded-lg">No brands found.</div>
        )}
      </section>
    </Layout>
  );
